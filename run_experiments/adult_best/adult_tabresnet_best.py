...
from general_utils.utils import set_lr_scheduler, set_optimizer
...
MODELS_DIR = WORKDIR / "best_models/adult/tabresnet"
...
if args.save_results:
    ...
    filename = "_".join(["adult_tabresnet_best", suffix]) + ".p"
    results_d = {}
    results_d["args"] = args
    results_d["acc"] = acc
