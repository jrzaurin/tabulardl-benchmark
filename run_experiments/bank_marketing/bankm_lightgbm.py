...
PROCESSED_DATA_DIR = ROOTDIR / "processed_data/bank_marketing_kaggle/"

RESULTS_DIR = WORKDIR / "results/bank_marketing_kaggle/lightgbm"
if not RESULTS_DIR.is_dir():
    os.makedirs(RESULTS_DIR)

MODELS_DIR = WORKDIR / "models/bank_marketing_kaggle/lightgbm"
