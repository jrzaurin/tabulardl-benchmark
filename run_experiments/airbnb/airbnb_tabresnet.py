...
RESULTS_DIR = WORKDIR / "results/airbnb/tabresnet"
...
# some manual cleaning (even though we won't use description): only dropping 8 rows
train = train[~train.description.isin([".", "2", "...", "W", "..", "P"])]
valid = valid[~valid.description.isin([".", "2", "...", "W", "..", "P"])]

drop_cols = ["id", "host_id", "host_since", "latitude", "description", "longitude"]
...
if args.save_results:
    ...
    filename = "_".join(["airbnb_tabresnet", suffix]) + ".p"
    results_d = {}
