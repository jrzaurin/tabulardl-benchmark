...
RAW_DATA_DIR = ROOT_DIR / "raw_data/fb_comments"
PROCESSED_DATA_DIR = ROOT_DIR / "processed_data/fb_comments"
...
fb_comments_train.to_pickle(PROCESSED_DATA_DIR / "fb_comments_train.p")
fb_comments_val.to_pickle(PROCESSED_DATA_DIR / "fb_comments_val.p")
fb_comments_test.to_pickle(PROCESSED_DATA_DIR / "fb_comments_test.p")
