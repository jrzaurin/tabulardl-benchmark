...
RAW_DATA_DIR = ROOT_DIR / "raw_data/bank_marketting"
PROCESSED_DATA_DIR = ROOT_DIR / "processed_data/bank_marketting"
...
bankm_train, bankm_test = train_test_split(
    bankm, random_state=SEED, stratify=bankm.target
)
bankm_val, bankm_test = train_test_split(
    bankm_test, random_state=SEED, stratify=bankm_test.target
)
